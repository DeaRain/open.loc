...
//check conflict  visual page module and simplcheckoutegit status
if (strpos_arr($_SERVER['QUERY_STRING'], array('checkout', 'simple'))) {
    require_once(\VQMod::modCheck(modification(DIR_SYSTEM . 'engine/loader2.php'), DIR_SYSTEM . 'engine/loader2.php'));
} else {
