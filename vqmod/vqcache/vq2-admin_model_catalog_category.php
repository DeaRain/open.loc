...
class ModelCatalogCategory extends Model {
	...
	public function addCategory($data) {
        ...
        if (isset($data['product_information_id'])) {
            $this->db->query("UPDATE " . DB_PREFIX . "category SET information_id = '" . (int)$data['product_information_id'] . "' WHERE category_id = ". (int)$category_id);
        }
    ...
    public function getCategoryInformation($category_id) {
        $query = $this->db->query("SELECT `information_id` FROM " . DB_PREFIX . "category WHERE category_id = '" . (int)$category_id . "'");
