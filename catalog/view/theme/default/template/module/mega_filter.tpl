...
<div class="box mfilter-box mfilter-box-<?php echo (int) $_idx; ?> mfilter-<?php echo $_position; ?><?php echo ! empty( $hide_container ) ? ' mfilter-hide-container' : '' ?><?php echo ! empty( $_displayOptionsAs ) && $_displayOptionsAs == 'modern_horizontal' ? ' mfilter-hide' : ''; ?>" id="mfilter-box-<?php echo (int) $_idx; ?>">
...
<!--								<i class="mfilter-head-icon"></i>-->
					...
					<div class="mfilter-content-opts"<?php 
						...
						<div class="mfilter-opts-container">
							<div class="mfilter-content-wrapper<?php echo $display_list_of_items == 'scroll' ? ' mfilter-iscroll' : ''; ?>"<?php echo $display_list_of_items == 'scroll' ? ' style="max-height:' . $mfp_options['display_list_of_items']['max_height'] . 'px"' : ''; ?>>
