        ...
        <div class="news-container__news">
            <?php foreach ($article as $articles) : ?>
                <div class="news-block">
                    <img src="<?php echo $articles['thumb']; ?>" alt="" class="news-block__img">
                    <a href="<?php echo $articles['href']; ?>" class="news-block__header"> <?php echo $articles['name'];?></a>
                    <span class="news-block__desc"><?php echo $articles['description']; ?>
                </div>
            <?php endforeach; ?>
        </div>
        <div class="news-container__button">
            <a href="<?php echo $newslink; ?>" class="main-theme-button">Всі новини</a>
        </div>
    </div>
</div>
